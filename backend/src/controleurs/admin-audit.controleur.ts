    ...
    entrees: entrees.map((entree) => ({
      ...
      auteur: entree.utilisateur
        ? {
            ...
            prenom: entree.utilisateur.prenom,
            nom: entree.utilisateur.nom,
            nomComplet: `${entree.utilisateur.prenom} ${entree.utilisateur.nom}`,
            email: entree.utilisateur.email,
            telephone: entree.utilisateur.telephone,
            role: entree.utilisateur.role,
            photoProfil: entree.utilisateur.photoProfil,
            nomSociete: entree.utilisateur.nomSociete,
            adresse: entree.utilisateur.adresse,
            ville: entree.utilisateur.ville,
            numeroClient: entree.utilisateur.numeroClient,
            actif: entree.utilisateur.actif,
            dateCreation: entree.utilisateur.dateCreation,
          }
        : null,
    })),
  });

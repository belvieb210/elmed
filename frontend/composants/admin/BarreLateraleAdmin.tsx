...
export function BarreLateraleAdmin({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-50 flex h-dvh max-h-dvh w-[min(300px,88vw)] flex-col overflow-hidden overscroll-none border-2 border-bleu-hero bg-white px-4 py-5 pt-[max(1.25rem,env(safe-area-inset-top))] pb-[max(1rem,env(safe-area-inset-bottom))] shadow-[8px_0_32px_rgba(79,116,255,0.16)] transition-transform duration-200 lg:inset-y-0 lg:h-auto lg:max-h-none lg:w-[280px] lg:border-y-0 lg:border-l-0 lg:border-r-2 lg:pb-5 lg:shadow-none ${

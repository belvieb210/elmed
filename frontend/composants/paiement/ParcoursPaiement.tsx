  ...
  return (
    <div className="mx-auto w-full max-w-6xl">
      <header className="mb-5 flex flex-wrap items-center justify-between gap-3">
        ...
        <Link
          href="/messagerie"
          className="inline-flex items-center gap-2 rounded-xl border border-bleu-hero bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50"
        >
      ...
      <div className="grid items-start gap-6 lg:grid-cols-12">
        <section className="rounded-2xl border border-bleu-hero bg-white p-4 shadow-sm sm:p-6 lg:col-span-7 xl:col-span-8">
          {etape === "accueil" && (
            <EcranAccueil
...
function EcranAccueil({
  ...
  return (
    <>
      ...
      <div className="mt-6 rounded-2xl border border-bleu-hero bg-slate-50/80 p-4">
...
function ApercuCanal({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex min-h-24 flex-col items-center justify-center gap-2 rounded-2xl border border-bleu-hero bg-white p-3 text-center hover:border-orange-paiement"
    >
      {children}
...
function CanalCarte({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex min-h-28 flex-col items-center justify-center gap-2 rounded-2xl border border-bleu-hero bg-white p-3 text-center shadow-sm hover:border-orange-paiement"
    >
      {children}
      <span className="text-xs font-medium text-slate-600">{titre}</span>
    </button>
...
function EcranCartes({
  ...
  return (
    <>
      <div className="flex items-center justify-between rounded-xl border border-bleu-hero px-3 py-3">
          ...
          return (
            <button
              ...
              className={`relative flex w-full items-center gap-3 rounded-xl border px-3 py-3 text-left ${
                active ? "border-orange-paiement" : "border-bleu-hero"
              }`}
            >
              <LogoVisa />
              <div>
    ...
    <>
      ...
      {!adresseIdentique && (
        <textarea
          ...
          className="mt-3 w-full rounded-xl border border-bleu-hero px-3 py-2 text-sm"
          rows={3}
        />
      )}
...
function EcranFlexPaie({
  ...
  return (
    <>
      <p className="text-3xl font-bold text-slate-900">{formaterMontant(total)}</p>
      <div className="mt-4 rounded-2xl border border-bleu-hero bg-sky-50 p-4">
      ...
      <label className="mt-5 block text-sm font-medium text-slate-700">
        ...
        <input
          ...
          className="mt-2 w-full rounded-xl border border-bleu-hero px-3 py-3 text-sm"
        />
      </label>
      <BoutonPayer libelle="Payer maintenant" enCours={enCours} onClick={onPayer} />
    </>
...
function EcranVirement({
  ...
  return (
    <>
      <p className="text-3xl font-bold text-slate-900">{formaterMontant(total)}</p>
      <div className="mt-4 space-y-2 rounded-2xl border border-bleu-hero bg-slate-50 p-4 text-sm">
  ...
  return (
    <div className="relative">
      <input
        ...
        inputMode={inputMode}
        type={type}
        className="w-full rounded-xl border border-bleu-hero px-3 py-3 pr-16 text-sm outline-none focus:border-orange-paiement"
      />
  ...
  return (
    <aside className="space-y-4 lg:sticky lg:top-20 lg:col-span-5 xl:col-span-4">
      <article className="rounded-2xl border border-bleu-hero bg-white p-5 shadow-sm">
        ...
        <dl className="mt-4 space-y-2 border-t border-bleu-hero pt-4 text-sm">
      ...
      <article className="rounded-2xl border border-bleu-hero bg-white p-4 text-xs text-slate-500 shadow-sm">

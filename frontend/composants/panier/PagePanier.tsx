  ...
  return (
    <MiseEnPageClient>
      ...
      {!panier || articles.length === 0 ? (
        <div className="rounded-2xl border border-bleu-hero bg-white p-8 text-center">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
            ...
            <div className="mb-3 flex items-center justify-between gap-2 rounded-xl bg-slate-100 px-3 py-2.5 text-xs sm:px-4 sm:text-sm">
              <label className="flex items-center gap-2 text-slate-600">
                <input
                  ...
                  className="h-4 w-4 rounded border-bleu-hero text-violet-marque"
                />
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="grid grid-cols-1 gap-2 sm:flex sm:flex-wrap">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl border border-bleu-hero bg-white px-4 py-2.5 text-sm font-semibold text-slate-800 hover:bg-slate-50"
                >
          ...
          <aside className="h-fit space-y-4 rounded-2xl border border-bleu-hero bg-white p-5">
            ...
            <div>
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 rounded-lg border border-bleu-hero px-2.5 py-1.5 text-xs font-medium text-slate-600 hover:bg-slate-50"
                >
              ...
              {carteEmbed && (
                <iframe
                  ...
                  src={carteEmbed}
                  className="mt-3 h-32 w-full rounded-xl border border-bleu-hero"
                />
              )}
            </div>
...
function LigneArticle({
  ...
  return (
    <article className="rounded-2xl border border-bleu-hero bg-white p-3 sm:p-4">
      <div className="flex items-start gap-3">
        <input
          type="checkbox"
          checked={selectionne}
          onChange={(evenement) => onSelection(evenement.target.checked)}
          className="mt-2 h-4 w-4 rounded border-bleu-hero text-violet-marque"
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center rounded-xl border border-bleu-hero">
